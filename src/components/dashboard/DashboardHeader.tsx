import { Shield, Signal, Users, Clock } from "lucide-react";
...
export function DashboardHeader({ criticalCount, warningCount, safeCount }: DashboardHeaderProps) {
  const now = new Date();
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-crisis-critical/10 border border-crisis-critical/30">
            ...
            <span className="text-[10px] text-crisis-critical/80">CRITICAL</span>
          </div>
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-crisis-warning/10 border border-crisis-warning/30">
            ...
            <span className="text-[10px] text-crisis-warning/80">WARNING</span>
          </div>
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-crisis-safe/10 border border-crisis-safe/30">
            ...
            <span className="text-[10px] text-crisis-safe/80">STABLE</span>
          </div>
        </div>
